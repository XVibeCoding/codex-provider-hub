...
Codex Session Hub 是一款面向 Windows 的本地桌面工具。它扫描保存在 `CODEX_HOME` 中的历史会话，并将全部会话或用户选中的会话恢复到当前 Provider。
...
3. 打开 Codex Session Hub，等待自动扫描完成。
...
<p align="center">扫码加入 Codex Session Hub 交流群：</p>

<p align="center">
  <img src="asserts/qq交流群.jpg" alt="Codex Session Hub QQ 交流群二维码" width="320" />
</p>
